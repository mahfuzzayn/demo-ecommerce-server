...
### Exporting Backend for Frontend
Goal: Prepare a markdown format with detailed instruction for frontend to connect and seamlessly work with backend without any issue.

Include: API Routes with Module separated, Instructions of Use in detail, request and response format.
Export to /src/docs/v7-backend-usage-guide.md